...
This is the second of two articles. [Part I: Architecture, Training, and Shifted Loss](/blog/medusa-multi-token-prediction/) develops the heads and their loss. This article begins exactly where training ends.
...
![Two-level Medusa candidate tree with two retained ranks at each level](/assets/img/medusa-candidate-tree.svg)
...
$$
\text{accepted Medusa tokens}=\text{accept\_length},
$$

$$
\text{committed tokens}=1+\text{accept\_length}.
$$
...
Return to [Part I: Architecture, Training, and Shifted Loss](/blog/medusa-multi-token-prediction/) for the training path.
